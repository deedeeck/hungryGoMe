    ...
    <p><a class="btn btn-primary btn-large" href="#">Read more »</a></p>
  	 ...
  	 <div class="row" style="text-align: center; padding: 0px;">
        <div style="display: inline-block; text-align: left; padding: 30px; background-color: #eeeeee; border-radius: 6px;">
			<h1 style="color: black; margin-top: 0;">Results for "<?php
				$rName = mysql_real_escape_string($_POST['search']);
				echo $rName;
			?>":</h1>
			...
			<?php
                ...
                $rName1 = '%'.$rName.'%';
                $result = mysql_query("SELECT DISTINCT stall_name FROM restaurant WHERE stall_name LIKE '$rName1' AND approve = '1'");
