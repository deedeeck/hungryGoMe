...
mysql_select_db("b12_13833487_123", $con);
	...
	$stallname =  $_POST['stallnames'];
	$rating = $_POST['rating'];
	$prices = $_POST['prices'];
	$comments = $_POST['comments'];
	
	$sql="INSERT INTO review (rating, prices, comments, m_email, r_stall_name, r_address, reviewdatatime)
	VALUES
	('$rating','$prices','$comments','$email','$stallname','$address',NOW())";
...
<div class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="container">
  	 <div class="row" style="text-align: center; padding: 50px; margin-bottom: 243px;">
        <div style="display: inline-block; text-align: left; padding: 30px; background-color: #eeeeee; border-radius: 6px;">
			
            <?php
        		if(isset($_SESSION['MM_Username'])) {
					//to prevent members from reviewing a restaurant twice
					if (!mysql_query($sql,$con)){
						die("Sorry, you have reviewed this restaurant before"); 
					} else {	
			?>			<header>
                        <!-- redirect in 5s -->
                        ...
                        <h3>New review submited, pending approval from the admins.</h3>
                        <p>You will be redirected back home in 5 seconds.</p><br/>
                        <p style="float: right; font-size: 12px; margin-bottom: 0;">
                        Not getting redirected? Click <a href="index.php">here</a> to return home.
                    	</p>
            <?php
					} 
					mysql_close($con);
